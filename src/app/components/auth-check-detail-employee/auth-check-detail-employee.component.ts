...
@Component({
  selector: 'app-auth-check-detail-employee',
  templateUrl: './auth-check-detail-employee.component.html',
  styleUrls: ['./auth-check-detail-employee.component.css']
})
export class AuthCheckDetailEmployeeComponent implements OnInit {
